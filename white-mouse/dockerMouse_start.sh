...
/usr/bin/docker run -d -p 8001:8001 -p 8999:8999 --link mysql5.7:dkMysql --name $appname $appname -v /etc/localtime:/etc/localtime:ro -v /etc/timezone:/etc/timezone:ro
